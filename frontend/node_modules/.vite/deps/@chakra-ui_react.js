  ...
  for (var _i = 0, stack_1 = stack; _i < stack_1.length; _i++) {
    ...
    if (parent_1 && ownerDocument.contains(parent_1)) {
      ...
      var aim = (
        ...
        (_e = (_d = left2 === null || left2 === void 0 ? void 0 : left2.nextElementSibling) !== null && _d !== void 0 ? _d : (
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react124.useMemo)(
    () => shouldWrapChildren ? import_react124.Children.map(children, (child, index2) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index2)) : children,
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime80.jsx)(import_react126.Fragment, { children: chunk.text }, index2);
  }) });
}
...
function useModalManager(ref, isOpen) {
  const [index2, setIndex] = (0, import_react143.useState)(0);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react171.useState)(index2);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react173.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
